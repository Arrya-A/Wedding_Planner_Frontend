...
<div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 p-5 "id="sec1">
...
<p className="justify-content-center align-items-center " style={{ textAlign: 'justify',alignItems:'center',color:'white' }}>
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Corrupti <br/>natus sequi esse ex quos qui
...
<div className=' col-lg-12 col-sm-12 col-md-12 col-xs-12'>
        <div className="d-flex justify-content-center align-items-center  section">
          <Dropdown className="dropdown-container w-100">
            <Dropdown.Toggle variant="white border rounded-2 w-100" >
              Category
            </Dropdown.Toggle>
          ...
          <div className="input-container justify-content-around ">
            <input type="text" placeholder="Location" className="text-center bg-transparent p-2 border-white rounded-2  w-100" id="location"/>
            <button className='btn btn-info ms-4  p-2 rounded-2' style={{width:'200px'}}id="search">Search</button>
          </div>
        </div>
